...
def training():
    ...
    options = [
        'Alternaria leaf spot', 'Brown spot', 'Frogeye leaf spot', 'Grey spot', 'Health', 'Mosaic', 'Powdery mildew',
        'Rust', 'Scab'
    ]
...
def main_account_screen():
    ...
    main_screen.title(" Heart  Disease Prediction")
